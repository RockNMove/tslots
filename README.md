...
| Поле | Тип | Описание |
|---|---|---|
| `Поклажедатель` | Справочник [Контрагент] | Контрагент, которому принадлежит товар. Критически важно: в перемещениях, списаниях и оприходованиях агент не указывается, и без этого поля занятость ячеек для таких операций невозможно привязать к клиенту. Поле 1:1 к товару — один товар всегда принадлежит одному поклажедателю. |
