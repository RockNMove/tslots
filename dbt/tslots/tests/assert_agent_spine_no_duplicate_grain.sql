...
-- Инвариант: каждая комбинация (store_id, slot_id, item_id, moment_day) встречается ровно один раз.
...
--   или grain CTE вернул дублирующиеся пары зерна —
...
GROUP BY store_id, slot_id, item_id, moment_day
HAVING COUNT(*) > 1
