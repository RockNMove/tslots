...
-- Инвариант: real_in и real_out в agent_spine равны суммам real_in и real_out из operations
...
GROUP BY a.id, a.slot_id, a.agent_id, a.item_id, a.moment_day, a.store_id, a.real_in, a.real_out
