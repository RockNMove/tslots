...
select doc_id, doc_moment::timestamptz as moment, doc_name as number,
       agent_id, doc_type, op_type,
       item_id, quantity, slot_id, doc_updated::timestamptz as updated
from demand_positions

union all
select doc_id, doc_moment::timestamptz, doc_name, agent_id,
       doc_type, op_type, item_id, quantity, slot_id, doc_updated::timestamptz
