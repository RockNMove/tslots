-- focus__slots_used_monthly.sql — агрегат занятости ячеек по месяцам в разрезе поклажедателей.
-- Строится на основе int_balance__slot_item_daily_spine (только is_used != 0).
